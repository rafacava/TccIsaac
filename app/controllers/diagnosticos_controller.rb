class DiagnosticosController < ApplicationController
  ...
  private
    ...
    def diagnostico_params
      params.require(:diagnostico).permit(:nome, :principal_fator_id, :secundario_fator_id, :terciario_fator_id, :principal_caracteristica_id, :secundaria_caracteristica_id, :terciaria_caracteristica_id)
    end
end
